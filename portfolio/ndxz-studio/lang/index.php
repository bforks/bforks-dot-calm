...
class Lang
{
	...
	*/
	...
	{
		return (isset($this->words[$string])) ? $this->words[$string] : $string;
	}
	...
	*/
	function lang_options()
	{
		return array(
			...
			'no-no' => array('no_NO.UTF-8', 'no_NO', 'no', 'nor', 'norwegian', 'no_NO.ISO_8859-1', 'Norwegian')
		);
	}
